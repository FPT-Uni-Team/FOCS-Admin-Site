...
import { deleteStaffStart, clearDeleteStaffState } from "../../store/slices/staff/staffDeleteSlice";
...
const StaffDetailPage = () => {
  ...
  const { loading: deleteLoading, success: deleteSuccess, error: deleteError } = useAppSelector((state) => state.staffDelete);
